...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        if (panelTable->columnCount() < 2)
            panelTable->setColumnCount(2);
        ...
        panelTable->setItem(0, 0, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        __qtablewidgetitem3->setTextAlignment(Qt::AlignLeading|Qt::AlignVCenter);
        panelTable->setItem(0, 1, __qtablewidgetitem3);
        panelTable->setObjectName(QStringLiteral("panelTable"));
        panelTable->setMinimumSize(QSize(300, 230));
